...
<body>
	...
	else
	{
		...
		{
			echo "<br><b>Calculated CO2 Emission: ".$row['CO2Emissions']." grams/km</b>";
	...
	var data = {
            ...
            datasets: [{
                label: 'Values',
                data: [<?php echo json_encode($emissionVal); ?>], 
                backgroundColor: ['#3498db'], // Colors for each category
                borderColor: '#fff',
	...
	// Get the canvas element and create a bar chart
        var ctx = document.getElementById('co2BarChart').getContext('2d');
        var co2BarChart = new Chart(ctx, {
            type: 'bar',
            data: data,
            options: {
